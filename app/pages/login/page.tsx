        ...
        >
          ...
          <form onSubmit={handleSubmit} className="space-y-4 w-full">
            ...
            <div className="flex items-center justify-between text-xs px-1 text-white/80">
              ...
              <a href="/forgot-password" className="hover:underline hover:text-white/90">
                Forgot password?
              </a>
            </div>
            ...
            <p className="text-center text-white/80 text-xs mt-4">
              ...
              <a href="/register" className="text-white font-semibold hover:underline hover:text-white/90">
                Sign up
              </a>
            </p>
          </form>
